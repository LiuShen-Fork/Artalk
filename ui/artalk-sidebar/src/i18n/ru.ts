...
export const ru: MessageSchema = {
  ...
  moderationBlocked: 'Отклонено',
  moderationReplaced: 'Заменено',
  moderationIntro:
    'Показывает результаты проверки по ключевым словам, ИИ и внешним сервисам модерации. Не заменяет список ожидающих комментариев.',
  moderationSummary: 'Всего записей: {total}; показаны последние {count}.',
  moderationNoMessage: 'Нет дополнительного сообщения модератора',
  moderationCommentUnavailable: 'Комментарий удален или недоступен',
  noModerationLogs: 'Журнал модерации пуст',
