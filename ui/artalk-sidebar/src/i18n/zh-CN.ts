...
export const zhCN: MessageSchema = {
  ...
  moderationReplaced: '已替换',
  moderationIntro: '展示关键词、AI 与外部审核服务的阶段性结果，不替代待审评论列表。',
  moderationSummary: '共 {total} 条记录，当前显示最近 {count} 条。',
  moderationNoMessage: '审核器未返回额外说明',
  moderationCommentUnavailable: '评论已删除或不可用',
  noModerationLogs: '暂无审核流水',
  moderationClear: '清空记录',
  moderationClearConfirm: '确认清空当前站点的全部审核记录？此操作不会删除评论。',
  moderationDeleteConfirm: '确认删除这条审核记录？此操作不会删除评论。',
  moderationApproveComment: '通过评论',
  moderationApproveCommentConfirm: '确认通过这条评论并公开显示？',
  moderationDeleteComment: '删除评论',
  moderationDeleteCommentConfirm: '确认删除这条评论及其回复？审核记录会保留。',
  refresh: '刷新',
  refreshing: '刷新中...',
  unknownUser: '未知用户',
  last: '近期',
