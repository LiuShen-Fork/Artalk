...
export const ja: MessageSchema = {
  ...
  dashboard: 'ダッシュボード',
  moderation: 'モデレーション',
  moderationBlocked: '異常',
  moderationReplaced: '置換済み',
  moderationIntro:
    'キーワード、AI、外部モデレーションサービスの段階的な結果を表示します。保留中のコメント一覧を置き換えるものではありません。',
  moderationSummary: '{total} 件中、最新 {count} 件を表示しています。',
  moderationNoMessage: 'モデレーターから追加のメッセージはありません',
  moderationCommentUnavailable: 'コメントは削除されたか、利用できません',
  noModerationLogs: 'モデレーションログはありません',
  moderationClear: '記録を消去',
  moderationClearConfirm: '現在のサイトの審査記録をすべて消去しますか？コメントは削除されません。',
  moderationDeleteConfirm: 'この審査記録を削除しますか？コメントは削除されません。',
  moderationApproveComment: 'コメントを承認',
  moderationApproveCommentConfirm: 'このコメントを承認して公開しますか？',
  moderationDeleteComment: 'コメントを削除',
  moderationDeleteCommentConfirm: 'このコメントと返信を削除しますか？審査記録は保持されます。',
  refresh: '更新',
  refreshing: '更新中...',
  unknownUser: '不明なユーザー',
  last: '最近',
