...
export const zhTW: MessageSchema = {
  ...
  dashboard: '總覽',
  moderation: '審核',
  moderationBlocked: '非正常',
  moderationReplaced: '已替換',
  moderationIntro: '顯示關鍵詞、AI 與外部審核服務的階段性結果，不取代待審評論列表。',
  moderationSummary: '共 {total} 筆記錄，目前顯示最近 {count} 筆。',
  moderationNoMessage: '審核器未傳回額外說明',
  moderationCommentUnavailable: '評論已刪除或無法使用',
  noModerationLogs: '暫無審核紀錄',
  moderationClear: '清空紀錄',
  moderationClearConfirm: '確認清空目前站點的全部審核紀錄？此操作不會刪除評論。',
  moderationDeleteConfirm: '確認刪除這條審核紀錄？此操作不會刪除評論。',
  moderationApproveComment: '通過評論',
  moderationApproveCommentConfirm: '確認通過這條評論並公開顯示？',
  moderationDeleteComment: '刪除評論',
  moderationDeleteCommentConfirm: '確認刪除這條評論及其回覆？審核紀錄會保留。',
  refresh: '重新整理',
  refreshing: '重新整理中...',
  unknownUser: '未知使用者',
  last: '最後',
