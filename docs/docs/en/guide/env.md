...
| **ATK_MODERATOR_AI_DISABLE_THINKING** | `false` | Disable model thinking (DeepSeek: thinking.disabled for Chat Completions, reasoning.effort=none for Responses) | moderator.ai.disable_thinking (Moderator > AI content moderation > Disable model thinking) |
