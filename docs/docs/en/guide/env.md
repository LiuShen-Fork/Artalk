...
| **ATK_MODERATOR_AI_API_TYPE** | `"responses"` | AI API type (maps to /v1/responses or /v1/chat/completions) (可选：`["responses", "chat_completions"]`) | moderator.ai.api_type (Moderator > AI content moderation > AI API type) |
