...
| **ATK_MODERATOR_AI_API_TYPE** | `"responses"` | AI 接口类型 (分别对应 /v1/responses 和 /v1/chat/completions) (可选：`["responses", "chat_completions"]`) | moderator.ai.api_type (评论审核 > AI 内容审核 > AI 接口类型) |
